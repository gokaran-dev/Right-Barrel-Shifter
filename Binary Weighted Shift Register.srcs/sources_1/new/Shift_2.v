...
module Shift_2(
        ...
        output [15:0]q
            ...
            MUX_2x1 m07(.data1(data[6]),.data2(data[8]),.y(q[6]),.sel(en));
            MUX_2x1 m08(.data1(data[7]),.data2(data[9]),.y(q[7]),.sel(en));
            
            MUX_2x1 m09(.data1(data[8]),.data2(data[10]),.y(q[8]),.sel(en));
            MUX_2x1 m10(.data1(data[9]),.data2(data[11]),.y(q[9]),.sel(en));
           
            MUX_2x1 m11(.data1(data[10]),.data2(data[12]),.y(q[10]),.sel(en));
