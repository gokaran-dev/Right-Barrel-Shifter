...
HD_PWD='D:/Mtech/Vivado/Binary Weighted Shift Register/Binary Weighted Shift Register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Shift_Divider.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Shift_Divider.tcl
